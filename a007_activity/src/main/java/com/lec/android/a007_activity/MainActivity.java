...
public class MainActivity extends AppCompatActivity {
    ...
    // 액티비티가 사용자에게 보여지기 시작할 때 (바로 직전)에 호출
    @Override
    ...
    // 액티비티를 통해 다루고 있던 데이터 저장, 쓰레드 중지.. 등의 처리를 해야함
    @Override
    ...
    // 액티비티가 더 이상 안보여질 때 호출되는 메소드
    // 메모리 상황에 따라 호출 안될수도 있다
    @Override
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putString("value", tvResult.getText().toString().trim());
    }
}//end Activity
